...
type SendNotificationRequest struct {
	...
	Placeholders  map[string]string      `protobuf:"bytes,3,rep,name=placeholders,proto3" json:"placeholders,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // A map of placeholders to replace in the tamplate body (e.g., {{username}} -> "Agung")
